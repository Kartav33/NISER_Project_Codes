...
plt.plot(X_,Y_,color='pink',label='$D_1$')
...
plt.plot(X_,Y_,color='m',label='$D_5$')
...
plt.xlim(0,7)
plt.ylim(0,1.1)
plt.title('Interpolation of n=3')
#plt.show()
...
plt.scatter(Xitpld1,YM,color='red',s=0.85, label='Linear Int. using 0 and 5') 
plt.scatter(Xitpld3,YM,color='black',s=0.85, label='Linear Int. using 1 and 5') 
...
plt.scatter(Xitpld,Yitpld,color='green',s=0.85, label='Qudratic int.')
